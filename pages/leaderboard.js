...
function getLeaderboard(achievements) {
  ...
  achievements.forEach((achievement, index) => {
    ...
    if (leaderboard[achievement.player]) {


      leaderboard[achievement.player].points += points;


      leaderboard[achievement.player].count += 1;


      leaderboard[achievement.player].achievements.push(achievement);


    } else {


      leaderboard[achievement.player] = { points, count: 1, achievements: [achievement] };
